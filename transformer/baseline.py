...
from transformer.prep import Outlier_Remover_with_Z_rands
...
class BaselineTransformer(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X):
        ...
        #Outlier_Remover_with_Z_rands
        
        outs = OutlierRemover_general_iqr(cols=["lng-n","lat-n"]+years+["taxyr-n","rmBltYr","bltYr-n"])
